runecoin version 0.5.4 is now available for download at:
...
http://gitorious.org/runecoin/runecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix runecoin-Qt notifications under Growl 1.3.
Increase required age of runecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxrunecoin properly when installing runecoin-Qt over it. (Windows)
