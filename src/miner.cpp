...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
  ...
  // Found a solution
  {
    ...
    return error("runecoinMiner : generated block is stale");
    ...
    return error("runecoinMiner : ProcessBlock, block not accepted");
  }
...
void static BitcoinMiner(CWallet *pwallet)
{
  ...
  {
    LogPrintf("runecoin miner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    ...
    {
      LogPrintf("runecoin miner terminated\n");
      throw;
    }
  }
