    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("runecoin Core") + " - ";
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a runecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and runecoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About runecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about runecoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for runecoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your runecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified runecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a runecoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the runecoin Core help message to get a list with possible runecoin command-line options"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("runecoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to runecoin network", "", count));
}
...
{
    QString strTitle = tr("runecoin"); // default title
